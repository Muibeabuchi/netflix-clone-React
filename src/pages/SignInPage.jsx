    ...
    <div className="fixed w-full px-4 py-24 z-[50]">
      <div className="max-w-[450px] h-[600px] mx-auto bg-black/75  text-white">
        <div className="max-w-[320px] mx-auto py-16">
          ...
          {error && <p className='bg-red-400 p-3 my-2 '>{error}</p>}
          <form onSubmit={handleSubmit} className='w-full flex flex-col py-4 '>
            <input onChange={(e)=>setEmail(e.target.value)}
             value={email} className='p-3 my-2 bg-gray-700 rounded ' type="email" placeholder='Email' autoComplete='email' required/>
            ...
            <div className="flex justify-between items-center text-gray-600 text-sm ">
              ...
              <p className='py-8 space-x-2'><span className='text-gray-600'>New To Netflix ?</span><Link to='/sign-up' > Sign Up</Link></p>
          </form>
        </div>
      </div>
    </div>
